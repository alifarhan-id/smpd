 ...
 *
 */
class T_penutupan_wp extends Abstract_model {
    ...
    public $selectClause    = "lpad(x.doc_no,5,'00000') as no_dokumen,x.* ";
    ...
    function updateDataVer($doc_no, $bap_employee_no_1, $bap_employee_no_2, $bap_employee_job_pos_1, $bap_employee_job_pos_2, $bap_employee_name_1, $bap_employee_name_2, $t_cust_acc_status_modif_id){

        $ci =& get_instance();
        $userdata = $ci->session->userdata;
        $user = $userdata['app_user_name'];

        $sql = "UPDATE t_cust_acc_status_modif SET 
                        doc_no='$doc_no', 
