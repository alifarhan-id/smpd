 ...
 *
 */
class T_piutang_skpdkb_nihil extends Abstract_model {
    ...
    public $fromClause      = "t_vat_setllement x left join p_finance_period a on a.p_finance_period_id = x.p_finance_period_id
