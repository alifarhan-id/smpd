 ...
 *
 */
class T_vat_setlement_manual extends Abstract_model {
    ...
    function insertUpdate($cust_acc_id,$period,$npwd,$ms_start,$ms_end,$kamar,$tot,$p_vat_type_dtl_id,$p_vat_type_dtl_cls_id){
        ...
        $sql = "SELECT * FROM f_vat_settlement_manual_new($cust_acc_id,$period,'$npwd','$ms_start','$ms_end',$kamar,$tot,$p_vat_type_dtl_id,$p_vat_type_dtl_cls_id,'$user')";
