 ...
 *
 */
class T_vat_setllement_manual_skpd_nihil extends Abstract_model {
    ...
    function insertUpdate($cust_acc_id,$period,$npwd,$ms_start,$ms_end,$p_vat_type_dtl_id,$p_vat_type_dtl_cls_id){


        $ci =& get_instance();
        $userdata = $ci->session->userdata;

        $sql = "SELECT * FROM f_vat_settlement_manual_new(?,?,?,?,?,0,0,?,?,?)";
