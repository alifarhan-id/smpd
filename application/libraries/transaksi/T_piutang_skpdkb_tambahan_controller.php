...
*/
class T_piutang_skpdkb_tambahan_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/t_piutang_skpdkb_tambahan');
            $table = $ci->t_piutang_skpdkb_tambahan;
            ...
            $req_param['where'][] = "x.p_settlement_type_id = 6";
