...
*/
class T_revenue_target_dtl_controller {

    function read() {

        $page = getVarClean('page','int',1);
        $limit = getVarClean('rows','int',5);
        $sidx = getVarClean('sidx','str','t_revenue_target_dtl_id');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/t_revenue_target_dtl');
            $table = $ci->t_revenue_target_dtl;
            ...
            $req_param['where'][] = 't_revenue_target_id = '.$t_revenue_target_id;
            ...
            $data['rows'] = $table->getAll(0, -1, 'p_vat_type_id', 'desc');
           // print_r($req_param);
            $data['success'] = true;
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','t_revenue_target_dtl_id');
    ...
    function submit(){
        ...
        $cusorderid= getVarClean('t_revenue_target_dtl_id','int',0);
        ...
        try {
            ...
            $result = $table->submit($cusorderid) ;
            $count = count($result);
