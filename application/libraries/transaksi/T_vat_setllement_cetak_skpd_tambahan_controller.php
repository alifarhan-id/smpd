...
/**
* Json library
* @class T_vat_setllement_cetak_skpd_tambahan_controller
...
class T_vat_setllement_cetak_skpd_tambahan_controller {
	...
	function read(){
        ...
        try {
        	if(!empty($s_keyword)){
        		$ci = & get_instance();
	            $ci->load->model('transaksi/t_vat_setllement_cetak_skpd_tambahan');
	            $table = $ci->t_vat_setllement_cetak_skpd_tambahan;
	            ...
	            $table->setCriteria("a.p_settlement_type_id =6");
	            ...
	            $data['rows'] = $table->getAll(0,0,'start_date', 'DESC');
	            $data['success'] = true;
        	} 
