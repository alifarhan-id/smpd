...
*/
class Chart_proc_daemon_controller {
    ...
    function read() {
        ...
        $p_w_chart_proc_id = getVarClean('p_w_chart_proc_id','int', 0);
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('workflow/chart_proc_daemon');
            $table = $ci->chart_proc_daemon;
