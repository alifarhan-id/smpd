...
class P_rqst_type_controller {
    ...
    function crud() {
        ...
        switch ($oper) {
            case 'add' :
                permission_check('can-add-rqst-type');
                $data = $this->create();
            break;

            case 'edit' :
                permission_check('can-edit-rqst-type');
                $data = $this->update();
            break;

            case 'del' :
                permission_check('can-delete-rqst-type');
                $data = $this->destroy();
            break;

            default :
                permission_check('can-view-rqst-type');
                $data = $this->read();
            break;
        }
    ...
    function create() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data added successfully';
                logging('create data jenis permohonan');
    ...
    function update() {
        ...
        if (isset($items[0])){
            ...
            try{
                ...
                $data['success'] = true;
                $data['message'] = 'Data update successfully';
                logging('update data jenis permohonan');
...
/* End of file p_rqst_type_controller.php */