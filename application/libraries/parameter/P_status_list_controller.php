...
/**
* Json library
* @class p_status_list_controller
...
class P_status_list_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','p_status_list_id');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/p_status_list');
            $table = $ci->p_status_list;
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','p_status_list_id');
...
/* End of file p_status_list_controller.php */