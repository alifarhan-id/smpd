...
/**
* Json library
* @class t_cetak_kartu_npwpd_dr_t_cust_account_controller
...
class T_cetak_kartu_npwpd_dr_t_cust_account_controller {
    ...
    function readData() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('pelaporan/t_cetak_kartu_npwpd_dr_t_cust_account');
            $table = $ci->t_cetak_kartu_npwpd_dr_t_cust_account;
            ...
            $req_param['where'][] = "a.npwd ilike '%".$s_keyword."%'
                    OR a.wp_name ilike '%".$s_keyword."%'
                    OR a.company_brand ilike '%".$s_keyword."%'";
