...
<label class="control-label col-md-5"><b>Petugas</b></label>
<div class="row">
    <div class="col-xs-12">
        <div class="portlet light bordered">
            <div class="form-body">
    ...
    <div class="col-xs-12">
        <div class="row">
            <div style="text-align: center;">
                <button class="btn btn-danger" type="button" id="btn-save" onclick="saveform();">SAVE</button>
...
<script type="text/javascript">
    function saveform(){
        ...
        $.ajax({
            type: 'POST',
            datatype: "json",
            url: '<?php echo WS_JQGRID."workflow.wf_controller/save_petugas_bap";?>',
            timeout: 10000,
            data: { 
