        ...
        <div class="portlet light bordered">
            <div class="form-body">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-danger" type="button" id="btn-sub" onclick="cetakNota()">CETAK NOTA DINAS</button>
                    <button class="btn btn-danger" type="button" id="btn-sub" onclick="cetakFormulir()">CETAK FORMULIR</button>
