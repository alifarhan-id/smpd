...
$("#tab-1").on("click", function(event) {
    ...
    loadContentWithParams("administration.p_app_user", {});
});
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            postData: { app_user_name : '<?php echo $this->input->post('app_user_name'); ?>'},
            datatype: "json",
            mtype: "POST",
            colModel: [
            ...
            caption: "Logs :: <?php echo $this->input->post('app_user_name'); ?>"
