...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."workflow.pembuatan_schema_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID',name: 't_schema_example_id', key: true, width: 35, sorttype: 'number', sortable: true, editable: true, hidden:true},
                {
                    label: 'Submit',
            ...
            editurl: '<?php echo WS_JQGRID."workflow.pembuatan_schema_controller/crud"; ?>',
            caption: "Pembuatan Schema"
