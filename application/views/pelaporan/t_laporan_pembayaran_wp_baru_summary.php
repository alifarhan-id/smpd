<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>LAPORAN PEMBAYARAN WP BARU SUMMARY</span>
        </li>
    </ul>
</div>
<!-- end breadcrumb -->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue bold uppercase"> LAPORAN PEMBAYARAN WP BARU SUMMARY
                    </span>
                </div>
            </div>
            <!-- CONTENT PORTLET -->
...
<script>
    ...
    jQuery(function ($) {
            ...
            jQuery("#grid-table").jqGrid({
                url: '<?php echo WS_JQGRID . "pelaporan.t_laporan_pembayaran_wp_baru_summary_controller/read"; ?>',
                datatype: "json",
                mtype: "POST",
                colModel: [
                    {label: 'BULAN',name: 'bulan',width: 700,sorttype: 'text'},
                    {label: 'BESARNYA',name: 'payment_amount',width: 300, align: "right",summaryTpl:"Jumlah: ",
        ...
        if(p_year_period_id == "" || year_code == ""){            
            ...
            jQuery(function($) {
                ...
                if($('#status_pembayaran').val() == "1"){
                    $("#grid-table").jqGrid("setCaption", "DAFTAR WP BARU SUMMARY DENGAN STATUS BAYAR : SUDAH PERNAH BAYAR");
                }else{
                    $("#grid-table").jqGrid("setCaption", "DAFTAR WP BARU SUMMARY DENGAN STATUS BAYAR : BELUM PERNAH BAYAR");
                }
