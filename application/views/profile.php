        ...
        <div class="portlet box green-jungle">
            ...
            <div class="portlet-body form">
                ...
                <form method="post" action="" class="form-horizontal" id="form-profile">
                    ...
                    <input type="hidden" name="id" value="<?php echo $this->session->userdata('p_app_user_id'); ?>">
                    <div class="form-body">

                        <div class="form-group">
                            <label class="col-md-3 control-label" for="username">Username</label>
                            <div class="col-md-4">
                                <input type="text" name="username" readonly="" class="form-control" value="<?php  echo $this->session->userdata('app_user_name'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="email" name="email" class="form-control required" value="<?php  echo $this->session->userdata('email_address'); ?>">
                            </div>
                        </div>
...
$("#form-profile").on('submit', (function (e) {
    ...
    $.ajax({
        url: "<?php echo WS_JQGRID."administration.p_app_user_controller/updateProfile"; ?>",
        type: "POST",
        data: data,
        dataType: "json",
