<div id="modal_coa" class="modal fade" tabindex="-1" style="overflow-y: scroll;">
    <div class="modal-dialog" style="width:700px;">
        <div class="modal-content">
            ...
            <input type="hidden" id="modal_lov_coa_code_val" value="" />
            <input type="hidden" id="modal_lov_coa_name_val" value="" />

            <!-- modal body -->
            <div class="modal-body">
                <div>
                  <button type="button" class="btn btn-sm btn-success" id="modal_coa_btn_blank">
...
<script>
    ...
    function modal_coa_prepare_table() {
        $("#modal_coa_grid_selection").bootgrid({
             formatters: {
                "opt-edit" : function(col, row) {
                    return '<a href="javascript:;" title="Set Value" onclick="modal_coa_set_value(\''+ row.coa_id +'\', \''+ row.coa_code +'\', \''+ row.coa_name +'\')" class="blue"><i class="fa fa-pencil-square-o bigger-130"></i></a>';
                },
                "status_display" : function(col, row) {
                    return '<i class="'+row.coa_code+' bigger-140"></i>';
                }
             },
             rowCount:[5,10],
             ajax: true,
             ...
             url: '<?php echo WS_BOOTGRID."parameter.p_coa_controller/readLov"; ?>',
             selection: true,
             sorting:true
        });
