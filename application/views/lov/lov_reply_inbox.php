                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="form-body">
                                <div class="row">
                                    <input type="hidden" name="t_message_inbox_bphtb_id" id="t_message_inbox_bphtb_id">
...
<script>
    ...
    function modal_ubah_flag_show(id){
        ...
        $('#t_message_inbox_bphtb_id').val(id);
...
<script>
     function balas(){
        ...
        t_message_inbox_bphtb_id = $('#t_message_inbox_bphtb_id').val();
        ...
        var var_url = "<?php echo WS_JQGRID . "transaksi.t_message_inbox_bphtb_controller/balas/?"; ?>";
            var_url += "<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>";
            var_url += '&t_message_inbox_bphtb_id='+t_message_inbox_bphtb_id;
