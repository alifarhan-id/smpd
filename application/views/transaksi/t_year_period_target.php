...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.t_year_period_target_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'p_year_period_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Target Pajak',name: 'detail',width: 120, align: "center",editable: false,
                    formatter: function(cellvalue, options, rowObject) {
                        var rowId = rowObject['p_year_period_id'];
                        return '<a href="#" onclick="showDetail('+rowId+');"> <i class="fa fa-list bigger-120"></i> </a>';
                    }
                },
                {label: 'Tahun',name: 'year_code',width: 100, align: "left"},
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.t_year_period_target_controller/read"; ?>',
            caption: "Daftar Tahun"
