...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>MASTER UBAH SKPDKB JABATAN</span>
        </li>
    </ul>
</div>
<!-- end breadcrumb -->
...
<script>
    $('#status_bayar').change(function() {
        ...
        $("#grid-table").jqGrid('setGridParam', {
            url: '<?php echo WS_JQGRID."transaksi.t_vat_setllement_skpdkbjabatan_modifikasi_controller/read"; ?>',
            postData: {
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.t_vat_setllement_skpdkbjabatan_modifikasi_controller/read"; ?>',
            caption: "MASTER UBAH SKPDKB JABATAN"
