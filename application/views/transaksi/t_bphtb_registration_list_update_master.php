...
<script>
    ...
    $('#detail-bphtb').on('click', function(event){
        ...
        //alert(id);
        loadContentWithParams('transaksi.t_bphtb_registration_master_plus', {FLAG:'',id:id});
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.t_bphtb_registration_list_update_master_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.t_bphtb_registration_list_update_master_controller/read"; ?>',
