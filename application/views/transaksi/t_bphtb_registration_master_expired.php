...
<script>
    ...
    function printLaporan(){
        ...
        url = "<?php echo base_url(); ?>"+"cetak_rep_bphtb_expired/pageCetak?t_bphtb_registration_id="+params;
        openInNewTab(url);
    }
...
<script>
    ...
    function restore(){
        ...
        var var_url = "<?php echo WS_JQGRID . "transaksi.t_bphtb_registration_list_expired_controller/restore/?"; ?>";
