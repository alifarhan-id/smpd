...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Penerima Surat Tugas</span>
        </li>
    </ul>
</div>
<!-- end breadcrumb -->
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaksi.t_assignment_letter_employee_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'Nomor Surat',name: 'letter_no',width: 250, align: "left"},
                {label: 'Tanggal Surat',name: 'letter_date_str',width: 170, align: "left"},
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.t_assignment_letter_employee_controller/read"; ?>',
            caption: "Daftar Penerima Surat Tugas"
    ...
    function print_pdf(t_cust_order_id){
        if(t_cust_order_id == ""){
            ...
            url = '<?php echo base_url(); ?>'+'cetak_formulir_skpd_nihil/pageCetak?t_cust_order_id='+t_cust_order_id;
            openInNewTab(url);
