...
class Cetak_formulir_sptpd_pdf extends CI_Controller{
	...
	function pageCetak() {
		...
		$pdf->SetFont('Arial', '', 8);
		$pdf->Cell($lheader2, $this->height+1, "Telp. ".getValByCode('ALAMAT_2')." - ".getValByCode('ALAMAT_3'), "BR", 0, 'C');
		$pdf->SetFont('Arial', '', 10);
		...
		$pdf->Cell(1, $this->height+2, "", "L", 0, 'C');
		...
		//$this->tulis("I. Berdasarkan Pasal 65 ayat (2) dan (3) Peraturan Daerah Kabupaten Lombok Utara Nomor 20 Tahun 2011 tentang Pajak Daerah, telah dilakukan","L",$pdf);
		$pdf->Cell(9, $this->height+2, "", "R", 0, 'C');
		$pdf->Ln();
