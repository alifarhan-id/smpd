...
class Cetak_formulir_ppj_pdf extends CI_Controller{
	...
	function pageCetak() {
		...
		if ($t_customer_order_id != 0) {
			$sql .= "select * from f_cetak_pajak_ppj(".$t_customer_order_id.", NULL, NULL, NULL, NULL, NULL, NULL, NULL, "
		."NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "
		."NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, " 
		."NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, " 
		."NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "
		."'refone', 'refone2', 'refone3');";
		...
		$pdf->Ln();
		$pdf->Cell($lengthCell, $this->height, "WAJIB PAJAK PENERANGAN JALAN", "LR", 0, 'C');
		$pdf->Ln();
		...
		*/
		...
		$pdf->Cell($per2, $this->height, "Pendataan Pajak Penerangan Jalan Non PLN", "TB", 0, 'L');
		$pdf->Cell($per3, $this->height, "", "TBR", 0, 'L');
		$pdf->Ln();
		
		//kolom ke 7
		$kol1 = ($lengthCell * 2) / 29;
		$kol2 = ($lengthCell * 5) / 29;
		$kol3 = ($lengthCell * 5) / 29;
		$kol4 = ($lengthCell * 5) / 29;
		$kol5 = ($lengthCell * 5) / 29;
		$kol6 = ($lengthCell * 5) / 29;
		$kol7 = ($lengthCell * 2) / 29;
		...
		$pdf->Cell($kol7, $this->height, "", "RT", 0, 'C');
		$pdf->Ln();
		...
		$pdf->Cell($kol7, $this->height*2, "", "R", 0, 'C');
		$pdf->Ln($this->height-5);
		$pdf->Cell($kol1, $this->height*2, "", "L", 0, 'C');
		$pdf->Cell($kol2, $this->height*2, "Golongan", 0, 0, 'C');
		$pdf->Cell($kol3, $this->height*2, "Kapasitas Daya", 0, 0, 'C');
		$pdf->Cell($kol4, $this->height+2, "Harga Satuan", 0, 0, 'C');
		$pdf->Cell($kol5, $this->height*2, "Faktor Daya", 0, 0, 'C');
		$pdf->Cell($kol6, $this->height*2, "Keterangan", 0, 0, 'C');
		$pdf->Cell($kol7, $this->height*2, "", "R", 0, 'C');
		$pdf->Ln($this->height);
		$pdf->Cell($kol1, $this->height, "", "L", 0, 'C');
		$pdf->Cell($kol2, $this->height, "", 0, 0, 'C');
		$pdf->Cell($kol3, $this->height, "", 0, 0, 'C');
		$pdf->Cell($kol4, $this->height-2, "Listrik", 0, 0, 'C');
		$pdf->Cell($kol5, $this->height, "", 0, 0, 'C');
		$pdf->Cell($kol6, $this->height, "", 0, 0, 'C');
		$pdf->Cell($kol7, $this->height, "", "R", 0, 'C');
		$pdf->Ln();
		
		//isi kolom
		$pdf->SetWidths(array($kol1, $kol2, $kol3, $kol4, $kol5, $kol6, $kol7));
		$pdf->SetAligns(array("C", "L", "C", "C", "C", "L", "C"));
		for ($i=0; $i<count($data2); $i++) {
		$pdf->RowMultiBorderWithHeight(array("",
											  $data2[$i]["pwr_classification_desc"],
											  $data2[$i]["power_capacity"],
											  $data2[$i]["service_charge"],
											  $data2[$i]["power_factor"],
											  $data2[$i]["description"],
											  "")
											 ,
										array('L',
		...
		$pdf->Cell($kol7, $this->height, "", "RB", 0, 'C');
		$pdf->Ln();
		
		$pdf->Cell($per1, $this->height, "12. ", "TBL", 0, 'C');
		$pdf->Cell($per2, $this->height, "Pendataan Pajak Penerangan Jalan PLN", "TB", 0, 'L');
		$pdf->Cell($per3, $this->height, "", "TBR", 0, 'L');
		$pdf->Ln();
		
		//kolom ke 8
		$kol_1 = ($lengthCell * 2) / 29;
		$kol_2 = ($lengthCell * 9) / 29; 
		$kol_3 = ($lengthCell * 8) / 29;
		$kol_4 = ($lengthCell * 8) / 29;
		$kol_5 = ($lengthCell * 2) / 29;
		
		$pdf->Cell($kol_1, $this->height, "", "LT", 0, 'C');
		$pdf->Cell($kol_2, $this->height, "", "TB", 0, 'C');
		$pdf->Cell($kol_3, $this->height, "", "TB", 0, 'C');
		$pdf->Cell($kol_4, $this->height, "", "TB", 0, 'C');
		$pdf->Cell($kol_5, $this->height, "", "RT", 0, 'C');
		$pdf->Ln();
		$pdf->Cell($kol_1, $this->height, "", "L", 0, 'C');
		$pdf->Cell($kol_2, $this->height, "Jumlah Pelanggan", 1, 0, 'C');
		$pdf->Cell($kol_3, $this->height, "Kapasitas Daya", 1, 0, 'C');
		$pdf->Cell($kol_4, $this->height, "Keterangan", 1, 0, 'C');
		$pdf->Cell($kol_5, $this->height, "", "R", 0, 'C');
		$pdf->Ln();
		//isi kolom 8 
		$pdf->SetWidths(array($kol_1, $kol_2, $kol_3, $kol_4, $kol_5));
		$pdf->SetAligns(array("C", "C", "C", "L", "C"));
		for ($i=0; $i<count($data4); $i++) {
		$pdf->RowMultiBorderWithHeight(array("",
											  $data4[$i]["owner_qty"],
											  $data4[$i]["power_capacity"],
											  $data4[$i]["description"],
											  "")
											 ,
										array('L',
		...
		$pdf->Cell($kol_1, $this->height, "", "LB", 0, 'C');
		$pdf->Cell($kol_2, $this->height, "", "B", 0, 'C');
		$pdf->Cell($kol_3, $this->height, "", "B", 0, 'C');
		$pdf->Cell($kol_4, $this->height, "", "B", 0, 'C');
		$pdf->Cell($kol_5, $this->height, "", "RB", 0, 'C');
		$pdf->Ln();
		...
		$pdf->Cell($npwpd1, $this->height, "", 1, 0, 'C');
		$pdf->Cell($spasi2-4, $this->height, "", 0, 0, 'C'); //spasi npwpd
		$pdf->Cell($npwpd2, $this->height, "", 1, 0, 'C');
		$pdf->Cell($spasi2-4, $this->height, "", 0, 0, 'C'); //spasi npwpd
		$pdf->Cell($npwpd3, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd4, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd5, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd6, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd7, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd8, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd9, $this->height, "", 1, 0, 'C');
		$pdf->Cell($spasi2-4, $this->height, "", 0, 0, 'C'); //spasi npwpd
		$pdf->Cell($npwpd10, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd11, $this->height, "", 1, 0, 'C');
		$pdf->Cell($spasi2-4, $this->height, "", 0, 0, 'C'); //spasi npwpd
		$pdf->Cell($npwpd12, $this->height, "", 1, 0, 'C');
		$pdf->Cell($npwpd13, $this->height, "", 1, 0, 'C');
		$pdf->Ln(6);
