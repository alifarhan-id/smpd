        ...
        <div class="portlet light bordered">
            <div class="form-body">
                ...
                <div class="row">
                    ...
                    <div class="input-group col-md-5">
                        <input type="text" class="form-control required" name="reg_letter_no" id="reg_letter_no" required>
                    </div>
                </div>
                <div class="space-2"></div>
                <div class="row">
...
<script type="text/javascript">
    ...
    function cetakNotaDinas() {
        ...
        var url = "<?php echo base_url(); ?>"+"nota_dinas_pdf/pageCetak?CURR_DOC_ID="+currDocId;
        PopupCenter(url, 'Nota Dinas', 600, 400);
    }
...
<script type="text/javascript">
    ...
    function submitform(){
        if ($('#reg_letter_no').val() == ''){
            swal('Informasi', 'Input Nomor Surat belum diisi','info');
            return;
        } 

        if ($('#npwpd').val() == ''){
            swal('Informasi', 'NPWPD belum digenerate','info');
            return;
        } 
