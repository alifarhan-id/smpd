...
<!-- parameter untuk kembali ke workflow summary -->
    ...
    <!--<input type="hidden" id="t_customer_order_id" value="698431" />-->
...
<script type="text/javascript">
    ...
    function showLOVUpload() {
        ...
        params_log.t_vat_setllement_id = $('#t_vat_setllement_id').val(),
        params_log.npwd                = $('#npwd').val(),
        params_log.t_cust_account_id   = $('#t_cust_account_id').val(),
        params_log.finance_period_code = $('#finance_period_code').val(),
        params_log.p_finance_period_id = $('#p_finance_period_id').val(),
        params_log.t_customer_order_id = $('#t_customer_order_id').val(),
        params_log.order_no            = $('#order_no').val(),
        params_log.p_rqst_type_id      = $('#p_rqst_type_id').val(),
        params_log.rqst_type_code      = $('#rqst_type_code').val(),
        params_log.ELEMENT_ID          =  $('#TEMP_ELEMENT_ID').val(),
        params_log.PROFILE_TYPE        =  $('#TEMP_PROFILE_TYPE').val(),
        params_log.P_W_DOC_TYPE_ID     =  $('#TEMP_P_W_DOC_TYPE_ID').val(),
        params_log.P_W_PROC_ID         =  $('#TEMP_P_W_PROC_ID').val(),
        params_log.USER_ID             =  $('#TEMP_USER_ID').val(),
        params_log.FSUMMARY            =  $('#TEMP_FSUMMARY').val(),
        params_log.CURR_DOC_ID         =  $('#CURR_DOC_ID').val(),
        params_log.CURR_DOC_TYPE_ID    =  $('#CURR_DOC_TYPE_ID').val(),
        params_log.CURR_PROC_ID        =  $('#CURR_PROC_ID').val(),
        params_log.CURR_CTL_ID         =  $('#CURR_CTL_ID').val(),
