...
<div class="row">
    ...
    <input type="hidden" id="t_debt_letter_id" value="<?php echo $this->input->post('t_debt_letter_id'); ?>" />
...
<script>
    $(function($) {
        ...
        $("#grid-table").jqGrid({
            ...
            datatype: "json",
            postData:{t_customer_order_id:<?php echo $this->input->post('CURR_DOC_ID'); ?>},
            mtype: "POST",
            colModel: [
