-- Function: f_bphtb_registration_kb_dengan_denda(character varying, character varying, character varying, character varying, character varying, numeric, numeric, numeric, character varying, character varying, character varying, character varying, character, character, character, character, character, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, character varying, character varying, numeric, character varying, numeric, character varying, numeric, numeric, numeric, numeric, numeric, character varying)

-- DROP FUNCTION f_bphtb_registration_kb_dengan_denda(character varying, character varying, character varying, character varying, character varying, numeric, numeric, numeric, character varying, character varying, character varying, character varying, character, character, character, character, character, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, character varying, character varying, numeric, character varying, numeric, character varying, numeric, numeric, numeric, numeric, numeric, character varying);

CREATE OR REPLACE FUNCTION sikp.f_bphtb_registration_kb_dengan_denda(
    ...
    IN month_quantity numeric,
    IN penalty_amt numeric,
    IN bphtb_amt_final_without_penalty numeric,
...
BEGIN
	...
	INSERT INTO "sikp"."t_bphtb_registration" (
		...
		"month_quantity",
		"penalty_amt",
		"bphtb_amt_final_without_penalty"
	)
VALUES
	(
		v_customer_order_id,
