...
*/
class P_room_type_controller {

    function read() {

        $page = getVarClean('page','int',1);
        $limit = getVarClean('rows','int',5);
        $sidx = getVarClean('sidx','str','p_room_type_id');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('parameter/p_room_type');
            $table = $ci->p_room_type;
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','p_room_type_id');
