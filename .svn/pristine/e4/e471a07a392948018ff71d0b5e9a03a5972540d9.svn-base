...
<script >
    ...
    function toExcel(){
        ...
        if( date_start_laporan == "" &&
            ...
            var url = "<?php echo WS_JQGRID . "transaksi.t_laporan_penerimaan_bphtb_pengurangan_v2_controller/excel/?"; ?>";
    ...
    function toPDF(){
        ...
        if(date_start_laporan == "" &&
            ...
            var url = "<?php echo base_url(); ?>"+"pdf_lap_penerimaan_bphtb_pengurangan_v2/save_pdf_t_lap_penerimaan_bphtb_pengurangan_v2?";
