...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Piutang SKPDKB Jabatan</span>
        </li>
    </ul>
</div>
<!-- end breadcrumb -->
...
<script>
    $('#status_bayar').change(function() {
        ...
        $("#grid-table").jqGrid('setGridParam', {
            url: '<?php echo WS_JQGRID."transaksi.t_piutang_skpdkb_jabatan_controller/read"; ?>',
            postData: {
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            colModel: [
                ...
                {name: 'Options',width: 200, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        ...
                        var url = '<?php echo base_url(); ?>'+'cetak_formulir_skpdkb_jabatan/pageCetak?t_vat_setllement_id='+val;
            ...
            editurl: '<?php echo WS_JQGRID."transaksi.t_piutang_skpdkb_jabatan_controller/read"; ?>',
            caption: "Piutang SKPDKB Jabatan"
