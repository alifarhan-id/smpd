...
*/
class T_revenue_target_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('transaksi/t_revenue_target');
            $table = $ci->t_revenue_target;
            ...
            $req_param['where'][] = 'p_year_period_id = '.$p_year_period_id;
            ...
            $data['rows'] = $table->getAll(0, -1, 't_revenue_target_id', 'asc');
           // print_r($req_param);
            $data['success'] = true;
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','t_revenue_target_id');
    ...
    function submit(){
        ...
        $cusorderid= getVarClean('t_revenue_target_id','int',0);
