...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."parameter.p_rqst_type_controller/crud"; ?>',
            //postData: { p_rqst_type_id : <?php //echo $this->input->post('p_rqst_type_id'); ?>},
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'p_rqst_type_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Jenis Permohonan',name: 'code',width: 150, align: "left",editable: true,
                    editoptions: {
                        size: 60,
                        maxlength:255
                    },
                ...
                {label: 'Jenis Pajak',
                    ...
                    editoptions: {
                        "custom_element":function( value  , options) {
                            ...
                            setTimeout( function() {
                                elm.append('<input id="form_vat_id" type="text"  style="display:none;">'+
                        ...
                        "custom_value":function( element, oper, gridval) {
                            ...
                            if(oper === 'get') {
                                return $("#form_vat_id").val();
                            } else if( oper === 'set') {
                                $("#form_vat_id").val(gridval);
                                var gridId = this.id;
                ...
                {label: 'Pengubah',name: 'updated_by',width: 150, align: "left",editable: false,
                    editoptions: {
                        size: 60,
                        maxlength:255
                    }
                },
                {label: 'Tanggal Ubah',name: 'updated_date_str',width: 150, align: "left",editable: false,
                    editoptions: {
                        size: 60,
                        maxlength:255
                    }
            ...
            editurl: '<?php echo WS_JQGRID."parameter.p_rqst_type_controller/crud"; ?>',
            caption: "Daftar Jenis Permohonan"
