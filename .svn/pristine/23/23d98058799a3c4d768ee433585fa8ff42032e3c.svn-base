<div id="modal_vat_type_dtl_cls" class="modal fade" tabindex="-1" style="overflow-y: scroll;">
    <div class="modal-dialog" style="width:700px;">
        <div class="modal-content">
            ...
            <input type="hidden" id="modal_lov_p_vat_type_dtl_cls_code_val" value="" />

            <!-- modal body -->
            <div class="modal-body">
                <div>
                  <button type="button" class="btn btn-sm btn-success" id="modal_vat_type_dtl_cls_btn_blank">
                    <span class="fa fa-pencil-square-o bigger-110" aria-hidden="true"></span> BLANK
                  </button>
                </div>
                <table id="modal_vat_type_dtl_cls_grid_selection" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
...
<script>
    $(function($) {
        $("#modal_vat_type_dtl_cls_btn_blank").on('click', function() {
            $("#"+ $("#modal_lov_p_vat_type_dtl_cls_id_val").val()).val("");
            $("#"+ $("#modal_lov_p_vat_type_dtl_cls_code_val").val()).val("");
            $("#modal_vat_type_dtl_cls").modal("toggle");
        });
    });
    ...
    function modal_vat_type_dtl_cls_set_field_value(the_id_field, the_code_field) {
         $("#modal_lov_p_vat_type_dtl_cls_id_val").val(the_id_field);
         $("#modal_lov_p_vat_type_dtl_cls_code_val").val(the_code_field);
    }

    function modal_vat_type_dtl_cls_set_value(the_id_val, the_code_val) {
         $("#"+ $("#modal_lov_p_vat_type_dtl_cls_id_val").val()).val(the_id_val);
         $("#"+ $("#modal_lov_p_vat_type_dtl_cls_code_val").val()).val(the_code_val);
         $("#modal_vat_type_dtl_cls").modal("toggle");

         $("#"+ $("#modal_lov_p_vat_type_dtl_cls_id_val").val()).change();
