 ...
 *
 */
class P_room_type extends Abstract_model {

    public $table           = "p_room_type";
    public $pkey            = "p_room_type_id";
    public $alias           = "pr";

    public $fields          = array(
                                'p_room_type_id'            => array('pkey' => true, 'type' => 'int', 'nullable' => true, 'unique' => true, 'display' => 'ID Room'),
    ...
    public $fromClause      = "p_room_type pr";
