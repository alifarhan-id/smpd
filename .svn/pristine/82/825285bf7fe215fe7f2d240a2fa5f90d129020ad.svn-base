...
$("#tab-3").on("click", function(event) {
    ...
    code = grid.jqGrid ('getCell', p_vat_group_id, 'year_code');//diem dlu
    ...
    window.location.href = "<?php echo base_url();?>"+"dashboard_target_vs_realisasi/index?p_year_period_id="+p_year_period_id+"&code="+code+"&mode=jenis"+"&p_vat_group_id="+p_vat_group_id+"&vcode="+vcode;
