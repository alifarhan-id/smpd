-- Function: f_bphtb_registration(character varying, character varying, character varying, character varying, character varying, numeric, numeric, numeric, character varying, character varying, character varying, character varying, character, character, character, character, character, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, character varying, character varying, numeric, character varying, numeric, character varying, numeric, numeric, numeric, numeric, numeric, character varying)

-- DROP FUNCTION f_bphtb_registration(character varying, character varying, character varying, character varying, character varying, numeric, numeric, numeric, character varying, character varying, character varying, character varying, character, character, character, character, character, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, character varying, character varying, numeric, character varying, numeric, character varying, numeric, numeric, numeric, numeric, numeric, character varying);
...
CREATE OR REPLACE FUNCTION sikp.f_bphtb_registration(
    ...
    IN i_land_area_real numeric,
    IN i_land_price_real numeric,
    IN i_building_area_real numeric,
    IN i_building_price_real numeric,
...
VALUES
	(
		...
		i_land_area_real,
		i_land_price_real,
		i_building_area_real,
		i_building_price_real,
		SYSDATE,
		i_user,
		SYSDATE,
		i_user,
